...
TEST_CONTRACT_DECODED_PARAMETERS = {'name': 'transfer', 'params': [
    {'type': 'address', 'value': '0xd11b80088ce2623a9c017b93008405511cd951d2'},
    {'type': 'uint256', 'value': '243571300000000000000'}]}
...
class ClickhouseContractABITestCase(unittest.TestCase):
    ...
    def test_pool(self):
        """Test pool size"""
        assert self.contracts.pool._processes == INPUT_PARSING_PROCESSES
